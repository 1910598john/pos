...
elseif (($item == '1 hour' && $foo_payment == 50) || ($item == 'Half hour' && $foo_payment== 110) || ($item == '2 hours' && $foo_payment == 0)) {
...
$sql = "UPDATE detailed_report SET item='$new_item_name', amount = amount + $foo_payment WHERE ticketNumber='$ticket' AND item='$item'";
